export default {
    ...
    template: `
        <nav class="sticky left-0 top-0 z-[9999] w-full bg-secondary/50 backdrop-blur-2xl px-4 md:px-6">
            <div class="container max-w-6xl py-5 flex flex-col m-auto">
                <div class="flex flex-row-reverse md:flex-row lg:flex-row items-center justify-between relative">
                    <!-- Search -->
                    <div class="relative max-full order-1 md:order-1 z-10">
                        <input type="text" name="search" id="search" class="w-full font-light grow py-2 px-4 text-base text-white placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-full bg-gray-900/50 pr-10 ring-1 ring-gray-400/25 focus:ring-gray-400/50 hidden md:block" placeholder="Search Movies" />
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center text-gray-300 hover:text-gray-200 pr-4 hidden md:flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="container max-w-6xl flex flex-col m-auto">
                <div class="flex items-center justify-between mb-4">
                    <!-- Navigation -->
                    <nav class="flex flex-col sm:flex-row sm:justify-between sm:items-center sm:gap-x-4 mt-4 md:mt-0 hidden md:flex">
                    ...
                    <!-- Select location -->
                    <div class="relative w-full sm:w-full md:w-auto lg:w-auto">
                        <select id="location" class="w-full font-light grow py-2 px-4 text-base text-white placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-full pl-12 cursor-pointer bg-transparent min-w-full" style="background: transparent">
                            <option value="1" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                All Cinemas
                            </option>
                            <option value="2" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Cinema 271 Mega Mall
                            </option>
                            <option value="3" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Cinema 271 Mega Mall
                            </option>
                            <option value="4" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Eden Garden
                            </option>
                            <option value="5" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend K Mall
                            </option>
                            <option value="6" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Meanchey
                            </option>
                            <option value="7" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Midtown Mall
                            </option>
                            <option value="8" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Noro Mall
                            </option>
                            <option value="9" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Olympia
                            </option>
                            <option value="10" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Premium Exchange Square
                            </option>
                            <option value="11" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend SenSok
                            </option>
                            <option value="12" class="bg-slate-900 text-white hover:bg-slate-800 p-3">
                                Legend Siem Reap
                            </option>
                            <option value="13" class="bg-gray-900 text-white hover:bg-gray-800 p-3">
                                Legend Toul Kork
                            </option>
                        </select>
                        <div class="absolute inset-y-0 left-0 flex items-center text-gray-400 hover:text-gray-300 pl-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
